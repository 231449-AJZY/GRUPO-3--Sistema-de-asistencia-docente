...
test('interpreta intento QR duplicado desde historial móvil unificado', () {
  final TeacherAttendanceItem item = TeacherAttendanceItem.mobileOperation(
    <String, dynamic>{
      'tipo_objetivo': 'CURSO',
      'fecha_curso': '2026-07-23',
      'hora_curso': '09:04:00',
      'estado_curso': 'PRESENTE',
      'curso': 'Ingeniería de Software',
      'aula': 'A-204',
      'resultado': 'DUPLICADA',
      'metodo_verificacion': 'QR_DINAMICO',
      'creado_en': '2026-07-23T14:05:00.000Z',
    },
  );

  expect(item.verificationMethod, 'QR_DINAMICO');
  expect(item.operationResult, 'DUPLICADA');
  expect(item.isCourse, isTrue);
  expect(item.course, 'Ingeniería de Software');
});
