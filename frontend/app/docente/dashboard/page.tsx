...
export default function DocenteDashboard() {
  ...
  return (
    <div className={`${styles.dashboard} admin-dashboard-animated`}>
      <PageHeader
        eyebrow="Panel docente"
        title="Dashboard del docente"
        description={`Bienvenido, ${docenteName} · Resumen de asistencia y actividad académica.`}
        actions={
          <Button
            type="button"
            variant="outline"
      ...
      <div className={styles.middleGrid}>
        <TeacherWeeklySchedule horarios={schedules} />
