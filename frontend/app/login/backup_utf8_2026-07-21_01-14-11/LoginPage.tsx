    ...
    <main ref={rootRef} className={styles.page}>
        ...
        <div className={styles.headerInner}>
          <div className={styles.headerBrand}>
            ...
            <div className={styles.universityText}>
              ...
              <p className={styles.universitySubtitle}>
                Excelencia académica e innovación institucional
              </p>
            </div>
          </div>
          ...
          <div className={styles.systemTitleBlock}>
            ...
            <p className={styles.systemSubtitle}>
              Plataforma institucional de autenticación biométrica
            </p>
          </div>
      ...
      <section className={styles.main}>
        <aside
          ...
          aria-label="Tecnología biométrica institucional"
        >
          ...
          <div className={styles.panelCopy}>
            <p className={styles.panelEyebrow}>
              Validación biométrica institucional
            </p>
            <h2 className={styles.panelTitle}>
              Identidad segura, acceso confiable
            </h2>
            <p className={styles.panelDescription}>
              Protección de credenciales, trazabilidad de accesos y
              preparación para reconocimiento biométrico docente.
            </p>
          </div>
          ...
          <div className={styles.biometricFacts}>
            <Feature
              ...
              description="Validación de identidad institucional."
            />
            <Feature
              icon={<ShieldIcon className={styles.factSvg} />}
              title="Datos protegidos"
              description="Autenticación y comunicación segura."
            />
          </div>
        </aside>
          ...
          >
            ...
            <div className={styles.cardContent}>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <input
                      ...
                      placeholder="correo@unsaac.edu.pe o código docente"
                ...
                >
                  ...
                  <p className={styles.roleHint}>
                    El sistema validará sus permisos con la cuenta
                ...
                >
                  ...
                  <span className={styles.messageText}>
                    {safeMessage ||
                      "Sistema seguro · datos biométricos protegidos"}
                  </span>
                </div>
              </form>
              ...
              <div className={styles.cardFooter}>
                ...
                <span>
                  Autenticación institucional protegida mediante JWT y
        ...
        >
          <div className={styles.securityCard}>
            ...
            <h2 className={styles.securityTitle}>
              Seguridad institucional en cada sesión
            </h2>
            <p className={styles.securityDescription}>
              El acceso se valida contra el servidor institucional y
              aplica permisos según el perfil registrado.
            </p>

            <ul className={styles.securityList}>
              <SecurityItem text="Sesiones con token autenticado" />
              <SecurityItem text="Contraseñas protegidas con bcrypt" />
              <SecurityItem text="Control de acceso por perfiles" />
              <SecurityItem text="Trazabilidad preparada para auditoría" />
            </ul>
          </div>
        </aside>
      </section>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerInner}>
          <p className={styles.footerText}>
            © 2026 UNSAAC · Sistema de Control de Asistencia Docente
          </p>
          ...
          <div className={styles.footerLinks}>
            ...
            <span aria-hidden="true">·</span>
            <span>Versión institucional</span>
          </div>
        </div>
      </footer>
    </main>
